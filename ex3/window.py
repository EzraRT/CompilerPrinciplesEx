...
class Ui_LR1(object):
    def setupUi(self, LR1):
        ...
        self.label_4 = QtWidgets.QLabel(LR1)
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(9)
        ...
        self.GramerList = QtWidgets.QListWidget(LR1)
        self.GramerList.setObjectName("GramerList")
        self.verticalLayout_5.addWidget(self.GramerList)
    ...
    def retranslateUi(self, LR1):
        ...
        LR1.setWindowTitle(_translate("LR1", "LR(1)分析"))
        self.openFileButton.setText(_translate("LR1", "选择文法文件"))
        self.label.setText(_translate("LR1", "输入待分析串："))
        self.analyzeButton.setText(_translate("LR1", "开始分析"))
        self.label_4.setText(_translate("LR1", "将分析的文法"))
        self.label_2.setText(_translate("LR1", "分析表"))
